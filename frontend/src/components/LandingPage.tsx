...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden relative">
      ...
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] animate-blob-morph opacity-60" style={{ animationDelay: '2s' }}>
        <div className="w-full h-full bg-gradient-to-tr from-purple-300/40 via-violet-200/30 to-transparent rounded-full blur-3xl animate-gentle-pulse" style={{ animationDelay: '1s' }} />
      </div>
      <div className="absolute top-1/3 right-1/4 w-[500px] h-[500px] animate-blob-morph opacity-50" style={{ animationDelay: '4s' }}>
        <div className="w-full h-full bg-gradient-to-br from-emerald-200/35 via-teal-200/25 to-transparent rounded-full blur-3xl animate-gentle-pulse" style={{ animationDelay: '2s' }} />
      </div>
      <div className="absolute bottom-1/4 right-1/3 w-[450px] h-[450px] animate-blob-morph opacity-55" style={{ animationDelay: '6s' }}>
        <div className="w-full h-full bg-gradient-to-tr from-amber-200/35 via-yellow-200/25 to-transparent rounded-full blur-3xl animate-gentle-pulse" style={{ animationDelay: '3s' }} />
      </div>
      <div className="absolute top-2/3 left-1/3 w-[400px] h-[400px] animate-blob-morph opacity-60" style={{ animationDelay: '3s' }}>
        <div className="w-full h-full bg-gradient-to-bl from-blue-300/35 via-sky-200/25 to-transparent rounded-full blur-3xl animate-gentle-pulse" style={{ animationDelay: '4s' }} />
      </div>
        ...
        <nav className="container mx-auto px-8 py-12">
          <div className="max-w-7xl mx-auto flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg tracking-wide font-handwritten text-2xl">ApplyFlow</span>
            </div>
          </div>
        </nav>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="max-w-4xl animate-fade-in-up">
              <div className="mb-16 space-y-6">
                <h1 className="text-[5rem] md:text-[7rem] lg:text-[9rem] leading-[0.9] tracking-tight">
                  Job search,
                  <span className="block italic bg-gradient-to-r from-rose-400 via-purple-400 via-violet-400 to-blue-400 bg-clip-text text-transparent animate-shimmer" style={{ backgroundSize: '200% auto' }}>
                    reimagined
                  </span>
                </h1>
              </div>
        ...
        <footer className="container mx-auto px-8 py-16">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 border-t border-border/60 pt-12">
              <div className="flex items-center gap-3">
                <div className="w-3 h-3 bg-gradient-to-br from-rose-400 via-pink-400 to-purple-400 rounded-full animate-gentle-pulse" />
                <span className="text-sm tracking-wide font-handwritten text-xl text-muted-foreground">ApplyFlow</span>
              </div>
